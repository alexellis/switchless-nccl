...
install -m 0644 "$ROOT/patches/nccl-2.30.7-hardened-switchless.patch" \
  "$STAGING/nccl-2.30.7-hardened-switchless.patch"
...
(
  ...
  sha256sum \
    ...
    nccl-2.30.7-hardened-switchless.patch > SHA256SUMS
)
